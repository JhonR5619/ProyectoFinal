<?php
  session_start();
  error_reporting(0);
  $conexion = new myqsli("localhost:8080","root","","DBVisitor");
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded=false>
                                    ...
                                    <li><a href="PaginaRegistro.html">Pagina principal</a></li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                          ...
                          <table>
                              ...
                              <?php
                                while ($registroFuncionarios = $resultado -> fecht_array(MYSQLY_BOTH))
                                {
                                  echo '<tr>
                                    <td>'.$registroFuncionarios['Nombre'].' </td>
                                    <td>'.$registroFuncionarios['Apellidos'].' </td>
                                    </tr>';
                                }
